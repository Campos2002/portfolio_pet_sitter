...
const data = [
  {
    image: AVTR1,
    clientName: 'Ellis Balmas',
    clientReview: '“Flávia foi a salvação para que pudéssemos viajar tranquilamente. Muito profissional e comprometida, além de imensamente carinhosa com toda turminha (que é grande). Calopsitas, gatos e cachorros. Todos tinhas seu momento especial com a tia Flávia. Ela registrava tudo (fotos e vídeos) e mandava em tempo real, para gente saber o que tava rolando. Estava muito apreensiva em ficar longe e fui positivamente surpreendida com essa experiência. Delegar nossos bens mais preciosos aos cuidar de outra pessoa não é tarefa fácil. Por isso, recomendamos com grande satisfação o trabalho da Flávia.”'
  },
  {
    image: AVTR2,
    clientName: 'Thaise Ferreira',
    clientReview: '“Flávia é extremamente atenciosa e amorosa com os pets, confio de olhos fechados em deixar meu filho com ela. Recomendo.”'
  },
  {
    image: AVTR3,
    clientName: 'Aniele Tinoco',
    clientReview: '“Perfeito!!! Flávia cuidou dos meus 4 gatos, tanto deles como da comida e da higiene! Recebi todos os relatórios ela foi super pontual e me passou toda segurança! MARAVILHOSA”'
  },
  {
    image: AVTR4,
  ...
  {
    image: AVTR4,
    clientName: 'Diney Ribeiro de Castro ',
    clientReview: 'Passando para agradecer o seu carinho e profissionalismo!! Você está de parabéns, seu carinho e amor pelos bichinhos fazem total diferença, sem contar a parte profissional.... Pela primeira vez eu vi um atendimento exemplar, tudo anotado e vc procurou saber de toda a rotina... Enfim, está de parabéns!!!!! Meus filhos gostaram tanto de vc e do seu carinho q teve até ciúmes! Hahahahaahah. Desde já agradeço e irei te indicar para todos os meus amigos!'
  },
];
